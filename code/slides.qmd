...
![Basketball Reference.](../pictures/reference.png)
...
stage.
Example:
![FiveThirtyEight.](../pictures/fivethirtyeight.png)


## "Probabilistic" approach
![Basketball Reference.](../pictures/bracket1.png)
...
and let $x_i$ be the $j$th predictor out of $n$.
...
![Basketball Reference.](../pictures/bracket2.png)
...
It worked great for UConn students!

Just make sure you don't pick too few or too many upsets.
T
